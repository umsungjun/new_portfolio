...
export default function Side() {
  ...
  return (
    <aside className="hidden max-w-[450px] w-[450px] h-screen items-center web:flex dark:text-white">
      <div className="w-full flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-3">
          <h3 className="text-2xl font-bold">{`${t("common.gitHub")} & ${t(
            "common.blog"
          )}`}</h3>
          <div className="flex w-full h-16 gap-24">
            ...
            >
              ...
              <span className="text-2xl font-black">{t("common.gitHub")}</span>
            </a>
            <a
            ...
            >
              ...
              <span className="text-2xl font-black">{t("common.blog")}</span>
            </a>
          </div>
        </div>
      </div>
